...
export default class extends Controller {
  ...
  connect() {
    this.validators = {
      form: new JustValidate(this.formTarget),
      addMod: new JustValidate(this.addModFormTarget),
      editMod: new JustValidate(this.editModFormTarget),
    };
  ...
  #initializeValidator() {
    ...
    allowTurbo(this.validators.form);
  }

  #initializeModValidators() {
    this.validators.addMod.addField("#add_mod_name", [{ rule: "required" }]);
    this.validators.editMod.addField("#edit_mod_name", [{ rule: "required" }]);
  }
